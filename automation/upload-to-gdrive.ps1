...
param(
    [string]$BuildPath = "C:\Users\ralfsuliman\Desktop\EXE\GEOSOIL Ausie",
    [string]$ProjectPath = "f:\Geosoil Drive\geosoil-ethernet-ausie",
    [string]$RclonePath = "",
...
foreach ($file in $FilesToUpload) {
    ...
    $success = Upload-UsingRclone -LocalPath $file.LocalPath -RemotePath "EXEAusie/$($file.RemoteName)"
